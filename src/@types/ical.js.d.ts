...
declare module 'ical.js' {
  ...
  export interface OccuranceDetails {
    recurranceId: Time;
    item: Event;
    startDate: Time;
    endDate: Time;
  ...
  type JCal = (JCal | Record<string, string> | string)[]
  ...
  export class RecurExpansion {
    ...
    public fromData(options: RecurExpansionData): void;
